        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.intro.display && (
            <Column textVariant="body-default-l" fillWidth gap="m" marginBottom="xl">
              ...
              <Row gap="16" paddingTop="24" wrap>
                <Button
                  href="mailto:azine@estin.dz"
                  variant="primary"
                  size="m"
                >
                  Let&apos;s Work Together
            ...
            <>
              ...
              <Column fillWidth gap="l" marginBottom="40">
                {about.projects.items.map((project, index) => (
                  <Column key={`${project.title}-${index}`} fillWidth gap="8" border="neutral-medium" radius="l" padding="24">
                    ...
                    <Text variant="body-default-s" onBackground="brand-weak" marginBottom="16">
                      {project.tech}
                    </Text>
                    <Row gap="12" wrap>
                      {project.buttons.map((btn, btnIndex) => (
                        <Button
                          key={btnIndex}
                          href={btn.href}
                          variant={btnIndex === 0 ? "secondary" : "tertiary"}
                          size="s"
                          prefixIcon={btn.icon as any}
                        >
                          {btn.label}
                        </Button>
                      ))}
                    ...
                    {skill.tags && skill.tags.length > 0 && (
                      <Row wrap gap="8" paddingTop="8">
                        {skill.tags.map((tag, tagIndex) => (
                          <Tag key={`${skill.title}-${tagIndex}`} size="l" prefixIcon={tag.icon as any}>
                            {tag.name}
                          </Tag>
                        ))}
                      </Row>
